...
class CostumersControllerTest < ActionController::TestCase
  ...
  test "should create costumer" do
    assert_difference('Costumer.count') do
      post :create, costumer: { direccion: @costumer.direccion, email: @costumer.email, facebook: @costumer.facebook, linkedln: @costumer.linkedln, nombre: @costumer.nombre, rfc: @costumer.rfc, telefono: @costumer.telefono }
    end
  ...
  test "should update costumer" do
    patch :update, id: @costumer, costumer: { direccion: @costumer.direccion, email: @costumer.email, facebook: @costumer.facebook, linkedln: @costumer.linkedln, nombre: @costumer.nombre, rfc: @costumer.rfc, telefono: @costumer.telefono }
    assert_redirected_to costumer_path(assigns(:costumer))
  end
